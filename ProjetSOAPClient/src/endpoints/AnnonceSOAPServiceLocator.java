...
public class AnnonceSOAPServiceLocator extends org.apache.axis.client.Service implements endpoints.AnnonceSOAPService {
    ...
    public endpoints.AnnonceSOAP getAnnonceSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public endpoints.AnnonceSOAP getAnnonceSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            endpoints.AnnonceSOAPSoapBindingStub _stub = new endpoints.AnnonceSOAPSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (endpoints.AnnonceSOAP.class.isAssignableFrom(serviceEndpointInterface)) {
                endpoints.AnnonceSOAPSoapBindingStub _stub = new endpoints.AnnonceSOAPSoapBindingStub(new java.net.URL(AnnonceSOAP_address), this);
                _stub.setPortName(getAnnonceSOAPWSDDServiceName());
                return _stub;
            }
        }
