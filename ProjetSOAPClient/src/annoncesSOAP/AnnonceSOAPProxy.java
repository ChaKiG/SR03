...
public class AnnonceSOAPProxy implements annoncesSOAP.AnnonceSOAP {
  private String _endpoint = null;
  private annoncesSOAP.AnnonceSOAP annonceSOAP = null;
  ...
  private void _initAnnonceSOAPProxy() {
    try {
      annonceSOAP = (new annoncesSOAP.AnnonceSOAPServiceLocator()).getAnnonceSOAP();
      if (annonceSOAP != null) {
        if (_endpoint != null)
  ...
  public annoncesSOAP.AnnonceSOAP getAnnonceSOAP() {
    if (annonceSOAP == null)
      _initAnnonceSOAPProxy();
    return annonceSOAP;
  }
