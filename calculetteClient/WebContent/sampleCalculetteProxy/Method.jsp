...
<LI><A HREF="Input.jsp?method=10" TARGET="inputs"> getCalculette()</A></LI>
<LI><A HREF="Input.jsp?method=13" TARGET="inputs"> add(int,int)</A></LI>
<LI><A HREF="Input.jsp?method=20" TARGET="inputs"> mul(int,int)</A></LI>
<LI><A HREF="Input.jsp?method=27" TARGET="inputs"> sou(int,int)</A></LI>
</UL>
</BODY>
</HTML>